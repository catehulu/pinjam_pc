    ...
    <div class="container">
        <form class="" action="{{ route('data.store') }}" method="post">
            ...
            <div class="form-group">
              <label for="">NRP</label>
              <input type="text" name="NRP" id="" class="form-control" placeholder="NRP" aria-describedby="helpId" maxlength="15">
              <small id="helpId" class="text-muted">NRP yang dimasukkan 15 digit</small>
            </div>
